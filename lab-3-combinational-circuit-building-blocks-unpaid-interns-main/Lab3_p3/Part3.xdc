#Constraint File for Lab 3 Part 2:
...
set_property -dict { PACKAGE_PIN T8    IOSTANDARD LVCMOS18 } [get_ports { mux_select[0] }]; #IO_L24N_T3_34 Sch=sw[8]
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS18 } [get_ports { mux_select[1] }]; #IO_25_34 Sch=sw[9]
...
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { DP_ctrl }]; #IO_L19N_T3_A21_VREF_15 Sch=dp
